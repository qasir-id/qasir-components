...
class FormItemUploadMultiple extends React.Component {
    ...
    componentWillReceiveProps(nextProps){
        if (nextProps.fileImages.length > 0){
            ...
            if (nextProps.fileImages.length != this.props.fileImages.length){
    ...
    render(){
        ...
        return (
            <FormItem label={label}>
                ...
                <br />
                <p style={{fontWeight:'normal'}}>*Hanya bisa menambahkan maksimal 5 foto dengan format JPG, JPEG, PNG, dengan maksimal jumlah ukuran file 10 MB.</p>
            </FormItem>
        )
    }
}
