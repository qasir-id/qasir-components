...
const SpanInner = styled.span `
    ...
    border-radius: 4px;
    height: 22px;
    background-color: ${props => props.checked ? "#F04B32" : "#fff" };
    border: 1px solid ${props => props.checked ? "#F04B32" : "#d9d9d9"};
    ...
    return (
        <Wapper>
            <Span checked={checked} disabled={disabled}>
                ...
                <SpanInner checked={checked} disabled={disabled}></SpanInner>
            </Span>
